...
rule family="ipv4" source address="61.142.131.0/24" port port="1235" protocol="tcp" accept
rule family="ipv4" source address="61.142.131.0/24" port port="1235" protocol="udp" accept
rule family="ipv4" source address="221.4.169.0/24" port port="1235" protocol="tcp" accept
rule family="ipv4" source address="221.4.169.0/24" port port="1235" protocol="udp" accept
...
rule family="ipv4" source address="183.237.44.0/24" port port="1235" protocol="tcp" accept
rule family="ipv4" source address="183.237.44.0/24" port port="1235" protocol="udp" accept
rule family="ipv4" source address="143.42.58.165" reject
rule family="ipv4" source address="139.144.183.199" reject
rule family="ipv4" source address="183.27.46.85" port port="1235" protocol="tcp" accept
rule family="ipv4" source address="183.27.46.85" port port="1235" protocol="udp" accept
...
rule family="ipv4" source address="112.96.80.0/24" port port="1235" protocol="tcp" accept
rule family="ipv4" source address="112.96.80.0/24" port port="1235" protocol="udp" accept
...
rule family="ipv4" source address="120.230.56.0/24" accept
rule family="ipv4" source address="192.168.194.0/24" accept
